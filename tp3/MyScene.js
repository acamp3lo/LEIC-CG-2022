...
export class MyScene extends CGFscene {
    ...
    initMaterials() {
        ...
        // Woody Material - TP3 Ex.4
        this.woodyMaterial = new CGFappearance(this);
        this.woodyMaterial.setAmbient(0.25, 0.16, 0.1, 1.0);
        this.woodyMaterial.setDiffuse(0.55, 0.38, 0.25, 1.0);
        this.woodyMaterial.setSpecular(0.07, 0.07, 0.07, 1.0);
        this.woodyMaterial.setShininess(10.0);


        this.materials = [this.material1, this.material2, this.material3, this.customMaterial, this.woodyMaterial];

        // Labels and ID's for object selection on MyInterface
        this.materialIDs = {'Red Ambient': 0, 'Red Diffuse': 1, 'Red Specular': 2, 'Custom': 3, 'Woody': 4 };
    }
