...
export class MyScene extends CGFscene {
    ...
    init(application) {
        ...
        this.cubeBottomTexture = new CGFtexture(this, 'images/mineBottom.png');

        this.cube = new MyUnitCubeQuad(this, this.cubeTopTexture, this.cubeSideTexture, this.cubeSideTexture, this.cubeSideTexture, this.cubeSideTexture, this.cubeBottomTexture);
        //------
